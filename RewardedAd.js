...
const rewarded = [
  { id: 1, title: "🥳 NullPointer Antivirus", text: "30 jours gratuits pour les devs motivés qui regardent jusqu'au bout !", background: "#42c5f4", image: { uri: "https://raw.githubusercontent.com/maparent1/ImagesProjetTest/main/assets/Antivirus.png" } },
];
...
export default function RewardedAd({ visible, onClose, onReward }) {
  ...
  useEffect(() => {
    ...
    if (timeLeft <= 0) { setCanClaim(true); return; }
        ...
        <View style={styles.overlay}>
          <View style={[styles.adBox, { backgroundColor: ad.background }]}>
            ...
            {canClaim ? (
              ...
              <Text style={styles.timerText}>⏳ Disponible dans {timeLeft}s</Text>
            )}
